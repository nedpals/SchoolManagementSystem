...
public class AddStudentSearch extends javax.swing.JFrame {
    Subject subject;
    
    /**
     * Creates new form Search
     */
    public AddStudentSearch(Subject subject) {
        initComponents();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
      ...
      try {
         Student[] results = Student.search(search);
         AddStudentResult frame = new AddStudentResult(results, subject);
         frame.setVisible(true);
         
         AddStudentSearch parent = this;
